...
import { Btn, Icon, Switch } from "../components/ui";

const FEATURES = [
  { icon: "students", text: "Student register with multiple parent numbers" },
  { icon: "attendance", text: "One-tap attendance with holiday protection" },
  { icon: "fees", text: "Fee engine: dues, partials, late fees, receipts" },
  { icon: "whatsapp", text: "Fee slips rendered as images for WhatsApp" },
];
    ...
    <div className="min-h-screen grid lg:grid-cols-[1.05fr_1fr]">
      ...
      <div className="bg-inkweave relative overflow-hidden flex flex-col justify-between px-8 sm:px-14 py-10 lg:min-h-screen border-b lg:border-b-0 lg:border-r border-ink-800">
        ...
        <div className="max-w-lg py-10 lg:py-0">
          <p className="text-[11px] font-bold tracking-[0.3em] text-gold-400 anim-fade-up" style={{ animationDelay: "80ms" }}>SINGLE-TUTOR · LOCAL-FIRST</p>
          ...
          <p className="text-[14px] text-ink-300 leading-relaxed mt-5 max-w-md anim-fade-up" style={{ animationDelay: "200ms" }}>
            Attendance, monthly fee cycles, dues and WhatsApp-ready fee slips for every batch from Nursery to First Year. Data never leaves this browser.
          </p>
        ...
        <p className="text-[11px] text-ink-500 anim-fade-up" style={{ animationDelay: "280ms" }}>
          Confidential product spec · Local-first MVP · localStorage is the source of truth
        </p>
      </div>

      {/* ---------- challan-style login ---------- */}
      <div className="bg-ledger flex items-center justify-center px-5 py-12">
        <form onSubmit={submit} className={`w-full max-w-[400px] anim-pop ${error ? "anim-shake" : ""}`}>
          <div className="card overflow-hidden">
            ...
            <div className="bg-ink-900 px-6 py-4 flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-ink-400 border border-ink-700 rounded px-1.5 py-0.5">No. TMS-001</span>
            </div>
